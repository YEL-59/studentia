...
const Platform = () => {
  return (
    <>
      <div>
        <div className="w-full bg-[#fff] dark:bg-[#070622] py-8">
          <div className="container mx-auto flex flex-col md:flex-row items-center justify-center p-3 md:p-0">
            {/* Left Section */}
            <div data-aos="fade-right">
              <h1 className="text-3xl md:text-[48px] font-medium leading-[132%] tracking-[-0.96px] font-['Space_Grotesk'] text-black dark:text-[#FFF] max-w-xl">
